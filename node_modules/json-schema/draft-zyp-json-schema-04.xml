...
Content-Type: application/json; 
		...
		<section title="Core Schema Definition">
			<t>
                ...
                (including usage and valid values) of a JSON values. JSON
...
<![CDATA[
{
	"type": ["string", "number"]
			...
			<section title="patternProperties" anchor="patternProperties">
				<t>
                    This attribute is an object that defines the schema for a set of property names
                    of an object instance.
                    The name of each property of this attribute's object is a regular expression
                    pattern in the ECMA 262/Perl 5 format, while the value is a schema.
                    If the pattern matches the name of a property on the instance object, the value
                    of the instance's property MUST be valid against the pattern name's schema
                    values.
                </t>
			</section>
				...
				<t>
					...
					<list style="hanging">
						<t hangText="Simple Dependency">
                            ...
                            a property with the same name as the dependency values.
			...
			<section title="exclusiveMinimum" anchor="exclusiveMinimum">
				<t>This attribute indicates if the value of the instance (if the instance is a
                    number) can not equal the number defined by the "minimum" attribute. This is
                    false by default, meaning the instance value can be greater then or equal to the
                    minimum values.</t>
			</section>
			
			<section title="exclusiveMaximum" anchor="exclusiveMaximum">
				<t>This attribute indicates if the value of the instance (if the instance is a
                    number) can not equal the number defined by the "maximum" attribute. This is
                    false by default, meaning the instance value can be less then or equal to the
                    maximum values.</t>
			</section>
